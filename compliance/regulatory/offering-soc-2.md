...
Отчеты SOC для Office 365 и другие сетевые службы, основанные на 12-месячном периоде выполнения (период аудита) с выпуском новых отчетов раз в полгода (конец периода — 31 марта и 30 сентября). *Промежуточные письменные заверения* выпускаются каждый квартал, чтобы охватить предыдущий трехмесячный период. Например, январское письменное заверение охватывает период с 1 октября по 31 декабря, апрельское письменное заверение охватывает период с 1 января по 31 марта, июльское письменное заверение охватывает период с 1 апреля по 30 июня, а октябрьское письменное заверение охватывает период с 1 июля по 30 сентября.
...
Ответы руководства находятся ближе к концу отчета об аттестации SOC. Поиск в документе по запросу "Ответ руководства ".

**Где можно увидеть обязанности пользователя?**

Обязанности субъектов-пользователей указаны в самом конце отчета об аттестации SOC. Поиск в документе по запросу "Обязанности субъектов-пользователей".
...
- [Раздел 100 TSP (AICPA, 2017: критерии служб доверия)](https://www.aicpa.org/content/dam/aicpa/interestareas/frc/assuranceadvisoryservices/downloadabledocuments/trust-services-criteria.pdf)
