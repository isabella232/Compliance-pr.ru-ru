...
GDPR предоставляет физическим лицам (или субъектам данных) определенные права в отношении обработки персональных данных, в том числе на ограничение такой обработки, на их исправление, удаление, получение, а также на выполнение запроса для передачи данных другому управляющему данных. Управляющий отвечает за предоставление своевременного ответа в соответствии с GDPR. Технические сведения см. в статье [Запросы субъектов данных](gdpr-data-subject-requests.md).  
...
Вы можете найти ряд статей, посвященных GDPR. Разработанные Microsoft, они предоставляют рекомендуемые подходы для локальной рабочей нагрузки для SharePoint Server, Exchange Server, Project Server, сервера веб-приложений Office, Office Online Server и локальных файловых ресурсов.
...
Согласно GDPR управляющему требуется выполнить DPIA до обработки данных, которая может привести к высокому риску нарушения прав и свобод физических лиц (в частности, до обработки с помощью новых технологий). В GDPR приведен следующий неполный список случаев, в которых необходимо проводить DPIA:
...
Microsoft предоставляет инструменты и документацию для поддержки вашей подотчетности GDPR. Это включает в себя поддержку прав субъекта данных, выполнение ваших собственных оценок влияния на защиту данных и совместную работу по устранению нарушений персональных данных.
...
- *Прозрачность*, *справедливость* и *законность* в обработке и использовании персональных данных. Вам будет необходимо уточнить у отдельных лиц, как вы используете личные данные, а также потребуется «законная основа» для обработки этих данных.
...
- *Ограничение хранения личных данных*. Вам нужно убедиться, что вы сохраняете личные данные лишь столько времени, сколько необходимо для достижения целей, для которых эти данные были собраны.
...
The GDPR provides EU residents with control over their personal data through a set of 'data subject rights'. Это включает в себя право на:
...
Это зависит от нескольких факторов, определенные в нормативных актах. В статье 37 GDPR говорится, что управляющие и обработчики данных должны назначать сотрудника по защите данных в любом случае, если: (а) обработка осуществляется государственным органом или учреждением, за исключением судов при осуществлении правосудия; (б) основная деятельность управляющего или обработчика данных состоит из операций по обработке данных, которые в силу своего характера, объема и/или целей, требуют регулярного и систематического мониторинга субъектов данных в больших масштабах; или (в) основная деятельность управляющего или обработчика данных заключается в обработке специальных категорий данных в больших масштабах согласно Статье 9 и персональных данных, касающихся судимостей и правонарушений согласно Статье 10.
...
GDPR регулирует сбор, хранение, применение и совместное использование персональных данных. Персональные данные имеют очень широкое определение, включая любые сведения, которые касаются идентифицированных или идентифицируемых физических лиц, проживающих в Европейском союзе (ЕС).
