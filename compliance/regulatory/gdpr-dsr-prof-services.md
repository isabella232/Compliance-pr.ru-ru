...
Когда персональные данные контактного лица клиента собираются в рамках предоставления технической поддержки, корпорация Майкрософт является управляющим данными.
...
В случаях, когда корпорация Майкрософт является управляющим данными, см. раздел <b>Запрос субъекта данных, предоставленных клиентом: коммерческая поддержка</b> ниже.
...
***Пример (исключительно в демонстрационных целях)** _
...
***Определив обращения, запросите применение DSR либо к определенной части записи, либо ко всем данным, связанным с этим обращением, из всех систем Майкрософт.** _
