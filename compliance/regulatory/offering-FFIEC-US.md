...
Microsoft Azure, microsoft Power BI и Microsoft Office 365 для удовлетворения строгих требований к предоставлению облачных служб для учреждений финансовых служб. Azure предоставляет финансовым учреждениям отчеты о проверках SOC 1 Type 2, SOC 2 Type 2 и SOC 3, выпускаемых независимой аудиторской фирмой, чтобы помочь клиентам выполнить свои собственные обязательства по соблюдению требований FFIEC. Например, атестация [SOC 1 Type 2](./offering-soc-1.md) выполняется в соответствии с:
...
Стандарт AICPA SSAE 18 заменил SAS 70, и он подходит для отчетности по средствам управления в организации-службе, соответствующей внутреннему контролю субъектов пользователей над финансовой отчетностью. Это формальный аудит, который финансовые учреждения могут использовать для сторонних обзоров поставщиков технологических услуг при выполнении собственных обязательств по обеспечению соответствия требованиям FFIEC для активов, развернутых в Azure. Он включает заключение аудитора об эффективности контроля для достижения связанных целей контроля в указанный период мониторинга.

Кроме того, Azure разработала Excel средства диагностики облачной безопасности на основе облачной безопасности, чтобы ускорить оценку рисков, которую финансовое учреждение может захоть провести по отношению к службам Azure. Инструмент основан на таблице с 19 отдельными доменами, которые определяют требования, установленные в соответствующих стандартах и нормативных актах, связанных с финансовыми службами, включая справочники по ИТ-экспертизе FFIEC.  Средство оценки рисков предварительно заполнено объяснениями того, как Azure соответствует требованиям, применимым к поставщикам облачных служб, и может помочь клиентам в выполнении собственных требований соответствия требованиям FFIEC.

Кроме того, для клиентов доступен компаньон для диагностики облачной безопасности Azure FFIEC, который предлагает рекомендации по использованию служб Azure и соображениям соответствия клиентов требованиям FFIEC.
...
Чтобы помочь финансовым учреждениям, поднадзорным FFIEC, использовать облачные решения, Корпорация Майкрософт опубликовала следующие руководящие документы, которые можно скачать из раздела Ресурсы защиты данных портала доверия [службы :](https://servicetrust.microsoft.com/ViewPage/TrustDocumentsV3)

- Azure — средство диагностики облачной безопасности
- Azure — компаньон по диагностике облачной безопасности FFIEC
