...
В ***Dynamics 365 Business Central*** имеется несколько способов поиска данных клиента. Дополнительные сведения см. в статье [Поиск, фильтрация и сортировка данных](/dynamics365/business-central/ui-enter-criteria-filters).
