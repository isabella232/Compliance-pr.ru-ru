...
Службы Microsoft 365 тесно связаны между собой, но системы и технологии, которые находятся за ними, спроектированы таким образом, чтобы ограничить воздействие одного инцидента службы на другие службы. Например, проблема, затрагивающая Exchange Online, не повлияет на основные возможности Teams, или проблема, связанная с функцией поиска в SharePoint Online, не повлияет на возможность отправки или скачивания файлов пользователями.
