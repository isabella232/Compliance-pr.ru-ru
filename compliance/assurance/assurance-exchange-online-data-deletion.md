...
- Связанная с почтовым ящиком учетная запись пользователя Azure Active Directory была стерта в течение последних 30 дней; Это максимальная продолжительность хранения, при которой Exchange Online будет хранить почтовый ящик в состоянии "мягкое удаление" до его окончательной и окончательной удаления и невозмежности.
