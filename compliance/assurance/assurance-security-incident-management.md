...
|**Team/Area**|**Описание**|
|:------------|:--------------|
| Центр Майкрософт по реагированию на угрозы | Определяет, отслеживает, устраняет и реагирует на инциденты безопасности и уязвимости безопасности программного обеспечения Майкрософт. |
...
| Команды обслуживания | Группы разработки Для Azure, Dynamics 365, Microsoft 365, которые отвечают за политики и решения, связанные с безопасностью для каждой службы. |
