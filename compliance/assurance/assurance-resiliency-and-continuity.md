...
Планирование емкости помогает группам служб выделять ресурсы, необходимые для поддержки доступности онлайн-служб Майкрософт. Регулярное планирование емкости требуется в рамках программы Microsoft EBCM. Группы служб проверяют данные о емкости во время ежеквартных обзоров и во время чрезвычайных ситуаций, которые требуют большей проверки емкости.
