...
ms.locfileid: "59160291"
---
# <a name="developing-your-business-continuity-plan"></a>Разработка плана непрерывности бизнеса

В этом разделе приводится руководство по разработке плана непрерывности бизнеса, учитывающего Microsoft 365 зависимостей. Здесь мы рекомендуем методы анализа ваших бизнес-функций и определения тех, которые зависят от служб Microsoft 365. Вы проводите этот анализ, учитывая, что будут сбои в работе служб и вам нужно подготовиться к таким возможным событиям.
